...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="fl">当前位置：行家注册</div>
      </div>
    </div>
    <div class="side">
    ...
    <div class="main" style=" overflow-y:auto; ">
        ...
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">行家注册</b></div>
            <div class="box_center">
              <form method="post" action="${pageContext.request.contextPath }/coach/coachRegist.action" class="jqtransform" enctype="multipart/form-data">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
               
               <tr>
                  <td class="td_right">名字：</td>
                  <td class=""> 
                    <input type="text" name="coachName" class="input-text lh30" size="40">
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="coachMobile" class="input-text lh30" size="40">
                 <span style="color:red">*</span> </td>
               </tr> 
                ...
                <tr >
                 ...
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="coachUsername" class="input-text lh30" size="40">
                 <span style="color:red">*</span> </td>
               </tr>
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="coachPassword" class="input-text lh30" size="40">
                  <span style="color:red">*</span></td>
               </tr>
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="coachIdentity" class="input-text lh30" size="40">
                  <span style="color:red">*</span></td>
               </tr> 
               ...
               <tr>
                  ...
                  <td class="">
                    <textarea name="coachIntroduction" id="" cols="30" rows="10" class="textarea"></textarea>
                 <span style="color:red">*</span> </td>
                 </tr>
               <tr>
                  <td class="td_right">回应时间（小时）：</td>
                  <td class=""> 
                    <input type="text" name="coachTime" class="input-text lh30" size="40">
                  <span style="color:red">*</span></td>
               </tr> 
               <tr>
                  <td class="td_right">上传照片：</td>
                  <td class=""> 
					<c:if test="${coach.coachPic !=null}">
					            <img src="/pic/${coach.coachPic}" width=100 height=100/>
					            <br/>
					        </c:if>
					        <input type="file" class="input-text lh30" size="40"  name="pic"/>  <span style="color:red">*</span>                </td>
               </tr> 
