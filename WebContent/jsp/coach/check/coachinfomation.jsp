...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="fl">当前位置：查看行家信息</div>
      </div>
    </div>
    <div class="side">
    ...
    <div class="main" style=" overflow-y:auto; ">
        ...
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">查看行家信息</b></div>
               ...
               <tr>
                  ...
                  <td class="td_left">${coach.coachMobile}</td>
               </tr> 
                                              
                <tr >
                  <td class="td_right">性别：</td>
                  <td class="td_left">${coach.coachGender}</td>
                 </tr>
                 
                 <tr>
                  <td class="td_right">行家名：</td>
                  <td class="td_left">${coach.coachUsername}</td>
               </tr>
               
               <tr>
                  <td class="td_right">密码：</td>
                  <td class="td_left">${coach.coachPassword}</td>
               </tr>
               
               <tr>
                  <td class="td_right">身份：</td>
                  <td class="td_left">${coach.coachIdentity}</td>
               </tr> 
               
               <tr>
                  <td class="td_right">自我介绍：</td>
                  <td class="td_left">${coach.coachIntroduction}</td>
               </tr>
               
               <tr>
                  <td class="td_right">回应时间（小时）：</td>
                  <td class="td_left">${coach.coachTime}</td>
               </tr>
               <tr>
                  <td class="td_right">指导过的人数：</td>
                  <td class="td_left">${coach.coachNumber}</td>
               </tr>
               
               <tr>
                  <td class="td_right">财产：</td>
                  <td class="td_left">${coach.coachMoney}</td>
               </tr>
    		</table>
    		</div>
    		</div>
