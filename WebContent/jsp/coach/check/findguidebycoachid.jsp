...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="fl">当前位置：查看自身的指导</div>
      </div>
    </div>
    <div class="side">
    ...
    <div class="main" style=" overflow-y:auto; ">
        ...
        <div class="box span10 oh">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                <tr>
                   <th width="250">指导名字</th>
                   <th width="100">指导种类</th>
                   <th width="100">指导时长</th>
                   ...
                   <th width="100">修改</th>
	        		...
	        		<tr class="tr">
	        		<form action="${pageContext.request.contextPath }/coach/check/findguidebyguideid.action">
	                    <td>${guide.guideName}</td>
	                    <td>${guide.guideType}</td>
				        <td>${guide.guideTimespan}</td>
				        <td>${guide.guidePrice }</td>
				        <td>
			     			<input type="hidden" value=${guide.guideId } name="guideId"></input>
						     <input type="submit" class="ext_btn ext_btn_submit" value="修改指导">						   
				        </td>	
                 		</tr>				        			        
			        </form>
                   </c:forEach>
