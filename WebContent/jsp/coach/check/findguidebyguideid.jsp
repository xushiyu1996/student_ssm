...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="fl">当前位置：修改指导信息</div>
      </div>
    </div>
    <div class="side">
    ...
    <div class="main" style=" overflow-y:auto; ">
        ...
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">修改指导信息</b></div>
            <div class="box_center">
              <form action="${pageContext.request.contextPath }/coach/check/updateguide.action" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
               <input type="hidden" value="${guide.guideId}" name="guideId">
               <tr>
                  <td class="td_right">指导时长：</td>
                  <td class=""> 
                    <input type="text" name="guideTimespan" value="${guide.guideTimespan}" class="input-text lh30" size="40">
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="guideTime" value="${guide.guideTime}" class="input-text lh30" size="40">
                <span style="color:red">*</span>  </td>
               </tr> 
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="guidePlace" value="${guide.guidePlace}" class="input-text lh30" size="40">
                 <span style="color:red">*</span> </td>
               </tr> 
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="guideName" value="${guide.guideName}" class="input-text lh30" size="40">
                <span style="color:red">*</span>  </td>
               </tr> 
               ...
               <tr>
                  ...
                  <td class="">
                    <textarea name="guideIntroduction" id="" cols="30" rows="10" class="textarea">
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" value="${guide.guidePrice}" name="guidePrice" class="input-text lh30" size="40">
                 <span style="color:red">*</span> </td>
               </tr> 
