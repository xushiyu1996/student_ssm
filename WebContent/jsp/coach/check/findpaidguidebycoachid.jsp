...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="fl">当前位置：查看被人购买的指导</div>
      </div>
    </div>
    <div class="side">
        ...
        <div class="box span10 oh">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                <tr>
                   ...
                   <th width="100">指导评分</th>
                   <th width="250">指导评价</th>
                    </tr>
                    
                	<c:forEach items="${listpaidguide}" var="paidguide" varStatus="id">                     
                	<tr class="tr">
	                    <td>${paidguide.guideName}</td>	                    
	                    <td>${paidguide.userName}</td>
				        <td>${paidguide.guidePrice}</td>
				        <td>${paidguide.guideRate }</td>
				        <td>${paidguide.guideRemark }</td>
				    </tr>    				        
                   </c:forEach>
