  ...
  <section id="main">
    <div class="container_12">
       ...
       <div id="content" class="grid_9">
		<h1 class="page_title">${coach.coachName}</h1>
		...
		<div class="product_page">
			...
			<div class="grid_5">
				<div class="entry_content">
					...
					<p style="font-size:large;">${coach.coachIdentity}</p>
					<div class="ava_price">
						<div class="availability_sku">							
							<div class="sku">
								回应时间: <span style="font-size:large;">${coach.coachTime}小时以内</span>
							</div>
							<div class="sku">
								指导过人数: <span style="font-size:large;">${coach.coachNumber}</span>
							</div>
						</div>
					</div>
					<div class="sku">
					简要介绍：<span style="font-size:large;">${fn:substringBefore(coach.coachIntroduction,"。")}</span>
					</div>
			...
			<div class="grid_9" >
				<div id="wrapper_tab" class="tab1">
					<a href="#" class="tab1 tab_link">行家介绍</a>
					<div class="clear"></div>
			...
			<div class="related">
				...
				<div class="list_carousel">
					<c:forEach items="${guidelist}" var="guide" varStatus="id">
		
						<article class="post">
							<h2 class="title_article"><a href="${pageContext.request.contextPath }/user/getDetailedGuide/${guide.guideId}.action ">${guide.guideName}</a></h2>
							<div class="content_article">
								<p>${guide.guideIntroduction}</p>
							</div>
							<div class="footer_article">
								<span><a href="${pageContext.request.contextPath }/user/getcoachinfomation.action?coachId=${guide.coachId }">${guide.coachName} </a></span> |
								<span>${guide.guidePrice}元, ${guide.guideTimespan}分钟, ${guide.guideNumber}人购买过</span>
