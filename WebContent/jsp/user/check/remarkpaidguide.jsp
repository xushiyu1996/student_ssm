...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="fl">当前位置：评价指导</div>
      </div>
    </div>
    <div class="side">
    ...
    <div class="main" style=" overflow-y:auto; ">
        ...
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">评价指导</b></div>
            <div class="box_center">
              <form action="${pageContext.request.contextPath }/user/check/ratepaidguide.action" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
               
               <tr>
                  <td class="td_right">评分：</td>
                  <td class=""> 
                    <input type="text" name="guideRate" value="${paidguide.guideRate }" class="input-text lh30" size="40">
                 <span style="color:red">*</span> </td>
               </tr>
                <input type="hidden" name="userId" value="${paidguide.userId }" >
               	<input type="hidden" name="guideId" value="${paidguide.guideId }" >
               
               
               <tr>
                  <td class="td_right">评价：</td>
                  <td class="">
                    <textarea name="guideRemark"  id="" cols="50" rows="10" class="textarea">${paidguide.guideRemark }</textarea>
                 <span style="color:red">*</span> </td>
                 </tr>
                 ...
                 <tr>                
                   ...
                   <td class="">
                     <input type="submit" name="button" class="btn btn82 btn_save2" value="评价"> 
