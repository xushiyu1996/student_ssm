...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="fl">当前位置：修改用户信息</div>
      </div>
    </div>
    <div class="side">
        ...
        <div class="box">
          <div class="box_border">
            ...
            <div class="box_center">
              <form action="${pageContext.request.contextPath }/user/check/updateuserinfomation.action" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
               <input type="hidden" value="${user.userId}" name="userId">
               <tr>
                  <td class="td_right">名字：</td>
                  <td class=""> 
                    <input type="text" name="userName" value=${user.userName} class="input-text lh30" size="40">
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="userMobile" value=${user.userMobile} class="input-text lh30" size="40">
                  <span style="color:red">*</span></td>
               </tr> 
                ...
                <tr >
                 ...
                 <tr>
                  ...
                  <td class=""> 
                    <input type="hidden" value=${user.userUsername} name="userUsername" class="input-text lh30" size="40">
                    ${user.userUsername}
                  </td>
               </tr>
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="userPassword" value=${user.userPassword} class="input-text lh30" size="40">
               ...
               <tr>
                  ...
                  <td class=""> 
                    <input type="text" value=${user.userUniversity} name="userUniversity" class="input-text lh30" size="40">
                  <span style="color:red">*</span></td>
               </tr> 
               ...
               <tr >
                 ...
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="userMajor" value=${user.userMajor} class="input-text lh30" size="40">
                  </td>
               </tr>
               ...
               <tr>
                  ...
                  <td class="">
                    <textarea name="userIntroduction" id="" cols="30" rows="10" class="textarea">
