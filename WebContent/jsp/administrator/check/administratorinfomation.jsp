    ...
    <div class="main" style=" overflow-y:auto; ">
        ...
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">查看管理员信息</b></div>
               ...
               <tr>
                  ...
                  <td class="td_left">${administrator.administratorMobile}</td>
               </tr> 
                                              
                <tr >
                  <td class="td_right">性别：</td>
                  <td class="td_left">${administrator.administratorGender}</td>
                 </tr>
                 
                 <tr>
                  <td class="td_right">用户名：</td>
                  <td class="td_left">${administrator.administratorUsername}</td>
               </tr>
               
               <tr>
                  <td class="td_right">密码：</td>
                  <td class="td_left">${administrator.administratorPassword}</td>
               </tr>
