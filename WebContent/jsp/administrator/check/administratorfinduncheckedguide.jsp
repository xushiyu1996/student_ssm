...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="fl">当前位置：查看管理员信息</div>
      </div>
    </div>
    <div class="side">
    ...
    <div class="main" style=" overflow-y:auto; ">
        ...
        <div class="box span10 oh">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                <tr>
                   <th width="100">行家</th>
                   <th width="150">指导名字</th>
                   <th width="100">指导种类</th>
                   <th width="500">指导简介</th>
                   <th width="100">指导价格</th>
                   <th width="100">审核</th>
                    </tr>
               <c:forEach items="${guidelist}" var="guide" varStatus="id">                      
                <tr class="tr">
	        		<form action="${pageContext.request.contextPath }/administrator/check/administratorcheckguide.action">
	                    <td>${guide.coachName}</td>
				        <td>${guide.guideName}</td>
				        <td>${guide.guideType}</td>
				        <td>${guide.guideIntroduction}</td>
				        <td>${guide.guidePrice}</td>
				        
				        <td>
				         <input type="hidden" value="${guide.guideId }" name="guideId">
				        <input type="submit" class="ext_btn ext_btn_submit" value="审核通过"></td>
			        </form>                   
                 </tr>
                 </c:forEach>
              </table>
